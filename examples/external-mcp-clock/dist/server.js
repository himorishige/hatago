...
server.registerTool('clock.getTime', {
...
server.registerTool('clock.getTimezone', {
    ...
    inputSchema: {
        ...
        properties: {
            timezone: {
                type: 'string',
                description: 'Specific timezone to get info about (optional)'
            },
            list: {
                type: 'boolean',
                description: 'Return list of common timezones',
                default: false
            }
        },
        additionalProperties: false
    ...
    const { timezone, list = false } = args;
    try {
        if (list) {
